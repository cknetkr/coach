window.MATH_S4 = String.raw`<div id="math-s4" class="inner-panel" style="display:none;">
    ...
    <section class="math-stage-card hero">
      <div class="math-stage-card-head">
        <div class="math-stage-card-kicker">STEP 4 · REAL EXAM RHYTHM</div>
        <div class="math-stage-card-title">타임어택은 빨리 푸는 훈련이 아니라, 어떤 문제를 어떤 개념으로 즉시 읽어낼지 속도를 붙이는 단계입니다.</div>
        <div class="math-stage-card-desc">실전처럼 40분 안에 풀되, <strong>개념 판별 속도, 버릴 문제 판단, 서술형 검산 습관</strong>을 같이 점검합니다.</div>
      </div>
      <div class="math-stage-note">권장 공부량: <strong>변형 세트 3회</strong>, <strong>총 18문항 이상</strong>, <strong>서술형 6문항 완주</strong>를 기준으로 실전 루틴을 고정하십시오.</div>
    </section>
    ...
    <div class="math-stage-card" style="margin-bottom:1rem;">
    ...
    <div class="math-stage-split" style="margin-bottom:1.25rem;">
      <div>
        <div class="math-stage-card">
    ...
    <div class="math-stage-card" style="margin-bottom:1.25rem;">
    ...
    <div class="math-stage-card" style="margin-top:1.25rem;">
